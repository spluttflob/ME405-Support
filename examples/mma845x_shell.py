...
This is a STM32 (Pyboard, Nucleo) only version. A more portable version would
use @c machine.I2C instead of @c pyb.I2C.
...
# Very simple test code which should be improved
if __name__ == "__main__":
    i2c = pyb.I2C(1, pyb.I2C.CONTROLLER)
    mma = MMA845x(i2c, 29)
    mma.active()
    print(f"Accel: {mma.get_ax():.3f},{mma.get_ay():.3f},{mma.get_az():.3f} g")
