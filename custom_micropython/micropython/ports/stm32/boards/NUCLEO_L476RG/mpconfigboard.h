...
// USART1 config: Changed below, so comment this out
...
// Either B10, B11 or C4, C5
#define MICROPY_HW_UART3_TX         (pin_C4)
#define MICROPY_HW_UART3_RX         (pin_C5)

// These pins go to the Arduino header only
#define MICROPY_HW_UART4_TX         (pin_A0)
#define MICROPY_HW_UART4_RX         (pin_A1)

// Compile with threading support
#define MICROPY_PY_THREAD           (1)
// Set the threading timeslice in ms; used in pybthread.c
#define THREAD_TIMESLICE            (1)

////////////////////////////////////////////////////////////
// CAN bus: Turn it off; we need the pins for Shoe USB-OTG
